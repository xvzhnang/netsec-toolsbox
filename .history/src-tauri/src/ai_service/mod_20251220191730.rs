...
pub use pool::{GatewayPool, GatewayWorker, WorkerStatus};
...
/// 初始化连接池
pub fn init_pool(pool_size: usize, base_port: u16) -> GatewayPool {
    GatewayPool::new(pool_size, base_port)
}
