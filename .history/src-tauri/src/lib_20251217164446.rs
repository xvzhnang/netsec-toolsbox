...
fn extract_exe_icon(file_path: &str) -> Result<DynamicImage, String> {
  ...
  use windows::Win32::Graphics::Gdi::{
    ...
    SelectObject, CreateDIBSection, DeleteObject, BITMAPINFO, BITMAPINFOHEADER, DIB_RGB_COLORS, BitBlt, SRCCOPY
  };
  ...
  unsafe {
    ...
    if BitBlt(hdc_mem, 0, 0, width as i32, height as i32, hdc_src, 0, 0, SRCCOPY).as_bool() {
      // 从 DIB 读取数据
