...
.tool-wiki-panel .markdown-body blockquote {
  margin: 1rem 0;
  padding: 10px 16px;
  background: linear-gradient(to right, rgba(255, 238, 248, 0.12) 0%, rgba(9, 12, 16, 0.75) 100%);
...
/* 标题样式 */
.tool-wiki-panel .markdown-body h1,
.tool-wiki-panel .markdown-body h2,
.tool-wiki-panel .markdown-body h3 {
  color: #FF9EC8;
