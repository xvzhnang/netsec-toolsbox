                ...
                tools: ((subCategory.tools || []) as unknown[]).map((tool: unknown) => {
                  ...
                  return {
                    ...
                    jarConfig: jarConfig ? {
                      ...
                      jvmArgs: Array.isArray((jarConfig as Record<string, unknown>).jvm_args || (jarConfig as Record<string, unknown>).jvmArgs) ? ((jarConfig as Record<string, unknown>).jvm_args || (jarConfig as Record<string, unknown>).jvmArgs as unknown[]).map(a => String(a)) : undefined,
                      programArgs: Array.isArray((jarConfig as Record<string, unknown>).program_args || (jarConfig as Record<string, unknown>).programArgs) ? ((jarConfig as Record<string, unknown>).program_args || (jarConfig as Record<string, unknown>).programArgs as unknown[]).map(a => String(a)) : undefined,
                    } : undefined,
                  }
                }),
              }
