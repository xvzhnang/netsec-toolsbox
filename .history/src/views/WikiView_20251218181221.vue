      ...
      <aside class="wiki-sidebar wiki-sidebar-right" :class="{ collapsed: tocCollapsed }">
        <div class="wiki-toc-section">
          <div class="wiki-toc-header">
            <h3 v-show="!tocCollapsed">页面目录</h3>
            <button 
            ...
            >
              <span class="toc-toggle-icon">
                <svg v-if="!tocCollapsed" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M5 6L8 9L11 6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
                <svg v-else width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M6 5L9 8L6 11" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              </span>
              <span v-if="tocCollapsed" class="toc-collapsed-label">目录</span>
            </button>
          </div>
...
// @ts-ignore - 已移除 UI，保留变量以防需要
const fontSize = ref(16) // 默认字体大小
// @ts-ignore - 已移除 UI，保留变量以防需要
const highContrast = ref(false) // 默认不高对比
...
.wiki-container:has(.wiki-sidebar-right.collapsed) {
...
.toc-toggle-btn:not(.collapsed) .toc-toggle-icon {
  transform: rotate(0deg);
}
...
.toc-toggle-btn.collapsed:hover .toc-collapsed-label {
  color: rgba(255, 255, 255, 0.9);
}
...
.wiki-sidebar-right.collapsed .wiki-toc-section {
  padding: 0;
}

.wiki-sidebar-right.collapsed .wiki-toc-header {
  flex-direction: column;
  align-items: center;
  gap: 8px;
  padding: 12px 8px;
...
/* 不同层级的样式 */
.wiki-toc-list > li > .wiki-toc-link {
  color: #d4d4d4;
  font-weight: 500;
  font-size: 12px;
...
.wiki-toc-list ul > li > .wiki-toc-link {
  color: #b8b8b8;
  font-size: 11px;
  padding: 4px 12px 4px 4px;
}

.wiki-toc-list ul ul > li > .wiki-toc-link {
  color: #a0a0a0;
  font-size: 10px;
...
.wiki-toc-list > li > .wiki-toc-link:hover {
  padding-left: 6px;
  padding-right: 12px;
}

.wiki-toc-list ul > li > .wiki-toc-link:hover {
  padding-left: 6px;
  padding-right: 12px;
}
...
.wiki-toc-list > li > .wiki-toc-link.active {
  padding-left: 3px;
  padding-right: 12px;
}

.wiki-toc-link.active:hover {
...
.wiki-toc-list > li > .wiki-toc-link.active:hover {
  padding-left: 3px;
  padding-right: 12px;
}

.wiki-toc-list ul > li > .wiki-toc-link.active:hover {
  padding-left: 3px;
  padding-right: 12px;
}
