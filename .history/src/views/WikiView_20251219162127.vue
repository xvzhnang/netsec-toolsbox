...
/* 美化整体显示 - PinkFairy 主题 */
.wiki-view {
  background: linear-gradient(135deg, var(--color-pink-tender, #FFF0F5) 0%, var(--color-pink-bright, #FFEEF8) 100%);
  color: #333;
  font-family: "微软雅黑", "Microsoft YaHei", sans-serif;
  min-height: 100vh;
  position: relative;
...
.wiki-view::before {
  ...
  bottom: 0;
  background: 
    radial-gradient(circle at 20% 50%, rgba(255, 158, 200, 0.1) 0%, transparent 50%),
    radial-gradient(circle at 80% 80%, rgba(255, 119, 204, 0.1) 0%, transparent 50%),
