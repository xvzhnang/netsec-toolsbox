  ...
  <div class="page">
    ...
    <main class="page-main">
      ...
      <div v-if="isAiOpen" class="content-row ai-open" @contextmenu="showBlankMenu">
        <div class="cards-column" :class="{ 'search-overlay-active': filteredResults.length }">
      ...
      <div v-else class="cards-row" @contextmenu="showBlankMenu">
        <div class="cards-row-inner" :class="{ 'search-overlay-active': filteredResults.length }">
          <div v-if="filteredResults.length" class="search-overlay">
            <div class="overlay-title">搜索结果</div>
            <div class="overlay-list">
              <button
...
/* 搜索结果覆盖层样式 */
.cards-column.search-overlay-active,
.cards-row-inner.search-overlay-active {
  position: relative;
}
