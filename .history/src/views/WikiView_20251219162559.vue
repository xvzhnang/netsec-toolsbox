...
.wiki-content article.markdown-body {
  ...
  transform: none;
  background: var(--color-pink-tender, #FFF0F5) !important;
...
/* 确保主题样式应用到我们的容器 */
.wiki-content {
  background-color: var(--color-pink-tender, #FFF0F5);
}
...
.wiki-content article.markdown-body pre ::selection {
  color: #fff !important;
  background-color: var(--color-pink-hot, #FF77CC) !important;
}
...
.wiki-content article.markdown-body pre {
  position: relative;
  background: var(--color-pink-tender, #FFF0F5) !important;
  border: 1px solid var(--color-pink-soft, #FF9EC8);
  border-radius: 12px;
...
.markdown-body pre code {
  ...
  line-height: 2rem;
  display: block;
  color: var(--color-pink-peach, #F39ACD);
}

/* highlight.js 代码高亮样式 - 适配 PinkFairy 主题 */
...
.markdown-body code:not(pre code) {
  background: var(--color-pink-bright, #FFEEF8);
  padding: 2px 4px;
  border-radius: 3px;
  font-size: 1.25rem;
  color: var(--color-pink-peach, #F39ACD);
...
/* markdown-it-attrs 支持的属性样式 - 适配 PinkFairy 主题 */
/* 带属性的文本 */
.markdown-body p.important,
.markdown-body .important {
    background: var(--color-pink-bright, #FFEEF8);
    padding: 8px 12px;
    border-left: 4px solid var(--color-pink-hot, #FF77CC);
    border-radius: 4px;
    margin: 1em 0;
    color: var(--color-pink-hot, #FF77CC);
}
...
.markdown-body .custom-title {
    color: var(--color-pink-soft, #FF9EC8);
    border-bottom: 2px solid var(--color-pink-soft, #FF9EC8);
    padding-bottom: 8px;
    margin-top: 1.5em;
    margin-bottom: 1em;
}
...
.code-copy-button:hover {
    ...
    border-color: var(--color-pink-hot, #FF77CC);
    transform: translateY(-1px);
    box-shadow: 0 4px 12px rgba(255, 119, 204, 0.3);
}
...
.markdown-body .katex-display {
  ...
  padding: 1rem;
  border-radius: 8px;
  border-left: 4px solid var(--color-pink-soft, #FF9EC8);
  margin: 1.5rem 0;
}
...
/* Mermaid 图表样式 - 适配 PinkFairy 主题 */
.markdown-body .mermaid {
  background: var(--color-pink-tender, #FFF0F5);
  border: 1px solid var(--color-pink-soft, #FF9EC8);
  border-radius: 12px;
  padding: 1rem;
  margin: 1rem 0;
...
.spinner {
  ...
  border-top-color: var(--color-pink-hot, #FF77CC);
  border-right-color: var(--color-pink-soft, #FF9EC8);
  border-radius: 50%;
...
.wiki-loading p {
  ...
  font-family: "微软雅黑", "Microsoft YaHei", sans-serif;
  text-shadow: 0 1px 2px rgba(255, 119, 204, 0.3);
}
...
.wiki-sidebar-left {
  ...
  background: linear-gradient(to bottom, 
    ...
    rgba(232, 255, 232, 0.95) 100%);
  border-right: 2px solid #90EE90;
  box-shadow: 4px 0 20px rgba(144, 238, 144, 0.4);
...
.wiki-sidebar-left::before {
  ...
  height: 100%;
  background: linear-gradient(to bottom, 
    var(--color-pink-soft, #FF9EC8) 0%,
    var(--color-pink-hot, #FF77CC) 50%,
    var(--color-pink-soft, #FF9EC8) 100%);
  opacity: 0.6;
}
...
.wiki-sidebar-header::before {
  ...
  background: linear-gradient(to right,
    transparent 0%,
    var(--color-pink-soft, #FF9EC8) 20%,
    var(--color-pink-hot, #FF77CC) 50%,
    var(--color-pink-soft, #FF9EC8) 80%,
    transparent 100%);
}
...
.wiki-sidebar-header h2 {
  ...
  text-shadow: 0 2px 4px rgba(255, 119, 204, 0.3);
  font-family: "微软雅黑", "Microsoft YaHei", sans-serif;
  position: relative;
  z-index: 1;
}
...
/* 搜索栏（文件导航上侧） - PinkFairy 主题 */
.wiki-search-section {
  padding: 16px 20px;
  border-bottom: 2px solid var(--color-pink-soft, #FF9EC8);
  flex-shrink: 0;
  background: linear-gradient(to bottom,
    rgba(255, 238, 248, 0.5) 0%,
...
.search-icon {
  ...
  pointer-events: none;
  z-index: 1;
  filter: drop-shadow(0 1px 2px rgba(255, 119, 204, 0.3));
}

.wiki-search-wrapper input {
  width: 100%;
  padding: 12px 40px 12px 40px;
  border: 2px solid var(--color-pink-soft, #FF9EC8);
  border-radius: 12px;
  font-size: 14px;
  ...
  backdrop-filter: blur(10px);
  box-shadow: 0 2px 8px rgba(255, 158, 200, 0.2);
  font-family: "微软雅黑", "Microsoft YaHei", sans-serif;
}

.wiki-search-wrapper input::placeholder {
  color: rgba(255, 119, 204, 0.5);
}
...
.wiki-search-wrapper input:focus {
  ...
  box-shadow: 0 0 0 4px rgba(255, 119, 204, 0.2), 
              0 4px 16px rgba(255, 158, 200, 0.4);
...
.search-clear-btn {
  ...
  padding: 0;
  border: none;
  background: rgba(255, 119, 204, 0.2);
  color: var(--color-pink-hot, #FF77CC);
  border-radius: 50%;
  cursor: pointer;
  display: flex;
...
.search-clear-btn:hover {
  background: var(--color-pink-hot, #FF77CC);
  color: white;
...
.search-results-dropdown {
  ...
  border: 2px solid var(--color-pink-soft, #FF9EC8);
  border-radius: 12px;
  box-shadow: 0 8px 32px rgba(255, 158, 200, 0.4),
              0 2px 8px rgba(255, 119, 204, 0.2);
  max-height: 400px;
  overflow: hidden;
  z-index: 100;
  display: flex;
...
.wiki-file-tree {
  ...
  border-radius: 16px;
  margin: 16px;
  box-shadow: 0 4px 20px rgba(255, 158, 200, 0.3),
...
.wiki-file-tree h3 {
  ...
  flex-shrink: 0;
  font-family: "微软雅黑", "Microsoft YaHei", sans-serif;
  text-shadow: 0 1px 2px rgba(255, 119, 204, 0.2);
  position: relative;
}
...
.wiki-breadcrumb {
  ...
  padding: 16px 24px;
  background: linear-gradient(to bottom, 
    rgba(255, 238, 248, 0.9) 0%, 
    rgba(255, 240, 245, 0.8) 100%);
  border-bottom: 2px solid var(--color-pink-soft, #FF9EC8);
  font-size: 14px;
  box-shadow: 0 2px 12px rgba(255, 158, 200, 0.3);
  backdrop-filter: blur(20px);
  position: sticky;
  top: 0;
  z-index: 10;
...
.breadcrumb-btn svg path {
  fill: var(--color-pink-hot, #FF77CC);
...
.markdown-body {
  ...
  box-shadow: -4px 0 20px rgba(255, 158, 200, 0.2);
  position: relative;
}
...
/* 美化整体显示 - 淡绿色背景，高对比度 */
.wiki-view {
  background: linear-gradient(135deg, #F0F8F0 0%, #E8F5E8 50%, #F5FBF5 100%);
  color: #1a1a1a;
  font-family: "微软雅黑", "Microsoft YaHei", sans-serif;
  min-height: 100vh;
  position: relative;
...
.wiki-view::before {
  ...
  bottom: 0;
  background: 
    radial-gradient(circle at 20% 50%, rgba(144, 238, 144, 0.08) 0%, transparent 50%),
    radial-gradient(circle at 80% 80%, rgba(152, 251, 152, 0.08) 0%, transparent 50%),
    radial-gradient(circle at 40% 20%, rgba(173, 255, 173, 0.05) 0%, transparent 50%);
  pointer-events: none;
  z-index: 0;
}
...
.wiki-content::-webkit-scrollbar-thumb {
  background: linear-gradient(to bottom,
    var(--color-pink-soft, #FF9EC8) 0%,
    var(--color-pink-hot, #FF77CC) 100%);
  border-radius: 6px;
  border: 2px solid rgba(255, 255, 255, 0.3);
  box-shadow: inset 0 1px 2px rgba(255, 119, 204, 0.3);
}
...
.markdown-body table th {
  ...
  padding: 16px 20px;
  text-align: left;
  border-bottom: 3px solid var(--color-pink-soft, #FF9EC8);
  border-right: 1px solid var(--color-pink-soft, #FF9EC8);
  color: var(--color-pink-hot, #FF77CC);
  letter-spacing: 0.5px;
  text-transform: uppercase;
  font-size: 14px;
...
.markdown-body table tbody tr:nth-child(even) {
  background: rgba(255, 238, 248, 0.4);
}
...
.markdown-body blockquote {
  border-left: 10px solid var(--color-pink-light, #ffaaff);
  padding: 20px 24px;
  color: var(--color-pink-hot, #FF77CC);
  background: linear-gradient(to right, 
    var(--color-pink-bright, #FFEEF8) 0%, 
    rgba(255, 240, 245, 0.8) 100%);
  ...
  backdrop-filter: blur(20px);
  position: relative;
  border-right: 2px solid var(--color-pink-soft, #FF9EC8);
  border-top: 2px solid var(--color-pink-soft, #FF9EC8);
  border-bottom: 2px solid var(--color-pink-soft, #FF9EC8);
}
...
.markdown-body blockquote::before {
  ...
  top: 12px;
  font-size: 56px;
  color: rgba(255, 119, 204, 0.3);
  font-family: Georgia, serif;
  line-height: 1;
  font-weight: bold;
}

/* markdown-it-container 自定义容器样式 - PinkFairy 主题 */
.markdown-body .tip,
.markdown-body .note,
.markdown-body .info,
...
.markdown-body .note,
.markdown-body .info {
  border-left-color: var(--color-pink-hot, #FF77CC);
  border-right-color: rgba(255, 119, 204, 0.3);
  border-top-color: rgba(255, 119, 204, 0.3);
  border-bottom-color: rgba(255, 119, 204, 0.3);
  background: linear-gradient(to right, 
    rgba(255, 119, 204, 0.15), 
    rgba(255, 255, 255, 0.8));
  color: #333;
}
...
/* 优化链接 - PinkFairy 主题 */
.markdown-body a {
  color: var(--color-pink-light, #ffaaff);
  text-decoration: underline;
  text-decoration-color: var(--color-pink-soft, #FF9EC8);
  transition: all 0.25s cubic-bezier(0.4, 0, 0.2, 1);
  font-weight: 500;
}
...
.markdown-body a:hover {
  color: var(--color-pink-hot, #FF77CC);
  text-decoration-color: var(--color-pink-hot, #FF77CC);
...
.markdown-body a.internal-link {
  color: var(--color-pink-hot, #FF77CC);
  font-weight: 600;
  border-bottom: 2px dashed var(--color-pink-hot, #FF77CC);
  text-decoration: none;
}

.markdown-body a.internal-link:hover {
  color: var(--color-pink-hot, #FF77CC);
  border-bottom-color: var(--color-pink-hot, #FF77CC);
...
.markdown-body img {
  ...
  border-radius: 16px;
  box-shadow: 
    -4px 0 16px rgba(255, 158, 200, 0.4),
    0 8px 24px rgba(255, 119, 204, 0.3);
  margin: 2em auto;
  display: block;
  object-fit: contain;
  border: 2px solid var(--color-pink-soft, #FF9EC8);
...
.markdown-body img:hover {
  ...
  box-shadow: 
    -6px 0 24px rgba(255, 158, 200, 0.5),
    0 12px 32px rgba(255, 119, 204, 0.4);
  border-color: var(--color-pink-hot, #FF77CC);
}
