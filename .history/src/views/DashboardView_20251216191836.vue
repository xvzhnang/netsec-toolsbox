...
<template>
  <div class="page">
    <header class="page-header">
      ...
      <div class="header-actions">
        <button
          ...
          :class="{ 'has-info': developerInfo.name || developerInfo.github || developerInfo.contact }"
          @click="showDeveloperModal = true"
        >
          <span class="developer-icon">👤</span>
          <span class="developer-name">{{ developerInfo.name || '开发者信息' }}</span>
        </button>
    ...
    >
      <div class="modal-form">
        <label class="field">
          <span class="field-label">开发者姓名</span>
          <input
            v-model="developerInfo.name"
            class="field-input"
            placeholder="开发者姓名（可选）"
          />
        </label>
        <label class="field">
          <span class="field-label">GitHub 链接</span>
          <input
            v-model="developerInfo.github"
            class="field-input"
        ...
        <label class="field">
          ...
          <input
            v-model="developerInfo.contact"
            class="field-input"
            placeholder="邮箱或其他联系方式（可选）"
          />
        </label>
        <div v-if="developerInfo.github || developerInfo.contact" class="developer-links">
          <div v-if="developerInfo.github" class="link-item">
          ...
          <div v-if="developerInfo.contact" class="link-item">
            <span class="link-label">联系方式:</span>
            <a
            ...
            <span v-else class="link-text">{{ developerInfo.contact }}</span>
          </div>
        </div>
        <div class="modal-form-actions">
...
.developer-info.has-info {
  border-color: rgba(77, 163, 255, 0.6);
  background: radial-gradient(circle at top left, rgba(77, 163, 255, 0.15), rgba(15, 23, 42, 0.95));
}
