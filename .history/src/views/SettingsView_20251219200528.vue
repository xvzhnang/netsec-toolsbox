            ...
            <div class="provider-config">
              ...
              <div class="config-form">
                <div class="form-group">
                  ...
                  <input
                    type="text"
                    :value="aiConfig.local?.api_url || 'http://localhost:11434/api/generate'"
                    @input="(e) => updateConfig('local', 'api_url', (e.target as HTMLInputElement).value)"
                    placeholder="http://localhost:11434/api/generate"
                    disabled
                  />
                </div>
                <p class="form-hint">本地模型功能开发中，敬请期待</p>
              </div>
            </div>
