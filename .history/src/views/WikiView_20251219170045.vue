...
.markdown-body blockquote {
  ...
  border-top: 2px solid rgba(255, 158, 200, 0.3);
  border-bottom: 2px solid rgba(255, 158, 200, 0.3);
}

/* 嵌套引用块样式 - 暗色背景 */
.markdown-body blockquote blockquote {
  border-left: 8px solid rgba(255, 170, 255, 0.6);
  margin-left: 20px;
  margin-right: 0;
  padding: 16px 20px;
  background: linear-gradient(to right, 
    rgba(255, 238, 248, 0.08) 0%, 
    rgba(9, 12, 16, 0.75) 100%);
  border-right: 1px solid rgba(255, 158, 200, 0.25);
  border-top: 1px solid rgba(255, 158, 200, 0.25);
...
.markdown-body blockquote blockquote blockquote {
  border-left: 6px solid rgba(255, 170, 255, 0.5);
  margin-left: 16px;
  padding: 12px 16px;
  background: linear-gradient(to right, 
    rgba(255, 238, 248, 0.06) 0%, 
    rgba(9, 12, 16, 0.8) 100%);
