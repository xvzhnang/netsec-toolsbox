...
const saveTool = async () => {
  ...
  debug('保存工具:', {
    ...
    pythonEnv: toolForm.value.toolType === 'Python' ? toolForm.value.pythonEnv : undefined,
  })
    ...
    >
      <div class="modal-form">
        ...
        <div class="form-section">
          ...
          <div class="icon-setting-row">
            <div class="icon-preview-box">
              <img v-if="toolForm.iconUrl" :src="toolForm.iconUrl" alt="图标预览" class="icon-preview-img" @error="handlePreviewError" />
            ...
            <div class="icon-input-area">
              <label class="field">
                ...
                <span class="field-hint">支持本地图片、网络 URL 或留空自动从可执行文件提取</span>
              </label>
            </div>
          </div>
        </div>
        ...
        <div class="form-section">
          ...
          <!-- JAR 类型工具的专门配置面板 -->
          <div v-if="toolForm.toolType === 'JAR'" class="config-panel">
            <label class="field">
              <span class="field-label">JAR 路径 <span class="required">*</span></span>
              <div class="field-with-button">
                <input
            ...
            <div class="tool-form-grid" style="margin-top: 12px;">
              <label class="field">
                <span class="field-label">Java 路径</span>
                <input
              ...
              <label class="field">
                <span class="field-label">JVM 参数</span>
                <input
                  v-model="toolForm.jvmArgsText"
                  class="field-input"
                  placeholder="-Xmx512m -D..."
                />
              </label>
            </div>
            <label class="field" style="margin-top: 12px;">
              <span class="field-label">程序参数</span>
              <input
                v-model="toolForm.programArgsText"
                class="field-input"
                placeholder="传递给 Java 程序的参数"
              />
            </label>
          </div>

          <!-- Python 类型工具的专门配置面板 -->
          <div v-else-if="toolForm.toolType === 'Python'" class="config-panel">
            <label class="field">
              <span class="field-label">脚本路径 <span class="required">*</span></span>
              <div class="field-with-button">
                <input 
            ...
            <div class="tool-form-grid" style="margin-top: 12px;">
              <label class="field">
                <span class="field-label">Python 环境</span>
                <div class="field-with-button">
                  <input
                    v-model="toolForm.pythonEnv"
                    class="field-input"
                    list="python-env-options"
                    placeholder="留空使用系统环境"
                  />
              ...
              <label class="field">
                <span class="field-label">脚本参数</span>
                <input v-model="toolForm.argsText" class="field-input" placeholder="-d example.com" />
              </label>
            </div>
          </div>
          
          <!-- 网页类型工具的配置 -->
          <div v-else-if="toolForm.toolType === '网页'" class="config-panel">
            <label class="field">
              <span class="field-label">URL 地址 <span class="required">*</span></span>
              <input
                v-model="toolForm.execPath"
                class="field-input"
          ...
          <!-- HTML 类型工具的配置 -->
          <div v-else-if="toolForm.toolType === 'HTML'" class="config-panel">
            <label class="field">
              <span class="field-label">HTML 文件路径 <span class="required">*</span></span>
              <div class="field-with-button">
                <input
                  v-model="toolForm.execPath"
                  class="field-input"
          ...
          <!-- LNK 类型工具的配置 -->
          <div v-else-if="toolForm.toolType === 'LNK'" class="config-panel">
            <label class="field">
              <span class="field-label">LNK 快捷方式路径 <span class="required">*</span></span>
              <div class="field-with-button">
                <input
                  v-model="toolForm.execPath"
                  class="field-input"
          ...
          <div v-else class="config-panel">
            <label class="field">
              <span class="field-label">可执行路径 <span class="required">*</span></span>
              <div class="field-with-button">
                <input 
                  v-model="toolForm.execPath" 
                  class="field-input" 
            ...
            <label class="field" style="margin-top: 12px;">
              <span class="field-label">运行参数</span>
        ...
        <div class="form-section">
          ...
          <label class="field">
            <span class="field-label">Wiki 文件路径</span>
            <input
              v-model="toolForm.wikiUrl"
              class="field-input"
              placeholder="例如：tools/test-case-1.md 或留空自动查找"
            />
            <span class="field-hint">输入 Wiki 文件的相对路径，或留空让系统根据工具名称自动查找</span>
          </label>
        </div>

        <div class="modal-form-actions">
          <button type="button" class="btn primary" @click="saveTool">保存配置</button>
