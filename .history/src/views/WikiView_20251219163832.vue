...
.wiki-sidebar-header h2 {
  ...
  text-shadow: 0 1px 2px rgba(139, 74, 107, 0.2);
  font-family: "微软雅黑", "Microsoft YaHei", sans-serif;
  position: relative;
  z-index: 1;
}
...
.wiki-view {
  background: linear-gradient(135deg, 
    ...
    rgba(255, 238, 248, 1) 50%, 
    rgba(255, 245, 250, 1) 100%);
  color: #1a1a1a;
  font-family: "微软雅黑", "Microsoft YaHei", sans-serif;
  min-height: 100vh;
  position: relative;
...
.wiki-view::before {
  ...
  background: 
    ...
    radial-gradient(circle at 40% 20%, rgba(255, 218, 225, 0.1) 0%, transparent 50%);
  pointer-events: none;
  z-index: 0;
}
