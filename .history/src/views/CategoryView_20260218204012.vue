    ...
    >
      <div class="modal-form">
        ...
        <div v-else-if="toolForm.toolType === 'Python'" class="python-config-panel">
          ...
          <label class="field">
            <span class="field-label">Python 环境（可选）</span>
            <input
              v-model="toolForm.pythonEnv"
              class="field-input"
              placeholder="例如：python-3.13 或留空使用系统环境"
            />
            <span class="field-hint">输入 .config/env/python 下的目录名，或留空使用系统 PATH 中的 python</span>
          </label>
          <label class="field">
