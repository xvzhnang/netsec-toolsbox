...
.wiki-sidebar-header::before {
  ...
  background: linear-gradient(to right,
    transparent 0%,
    rgba(255, 158, 200, 0.4) 20%,
    rgba(255, 119, 204, 0.4) 50%,
    rgba(255, 158, 200, 0.4) 80%,
    transparent 100%);
  opacity: 0.8;
}
...
.markdown-body blockquote {
  ...
  backdrop-filter: blur(20px);
  position: relative;
  border-right: 2px solid rgba(255, 158, 200, 0.25);
  border-top: 2px solid rgba(255, 158, 200, 0.25);
  border-bottom: 2px solid rgba(255, 158, 200, 0.25);
  transition: all 0.3s ease;
}
