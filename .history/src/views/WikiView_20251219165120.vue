...
.wiki-content article.markdown-body {
  ...
  transform: none;
  background: rgba(9, 12, 16, 0.3) !important;
...
.wiki-content article.markdown-body pre {
  position: relative;
  background: rgba(27, 31, 35, 0.6) !important;
...
/* 行内代码样式 - 使用 PinkFairy 主题颜色 */
.markdown-body code:not(pre code) {
  background: rgba(255, 238, 248, 0.2);
  padding: 2px 4px;
  border-radius: 3px;
  font-size: 1.25rem;
  color: #F39ACD;
...
.markdown-body .custom-title {
    color: #FF9EC8;
    border-bottom: 2px solid #FF9EC8;
    padding-bottom: 8px;
    margin-top: 1.5em;
    margin-bottom: 1em;
}
...
.code-copy-button.copied {
    background: rgba(255, 119, 204, 0.35);
    border-color: rgba(255, 119, 204, 0.6);
    color: #FF77CC;
}
...
/* KaTeX 公式样式 - 适配暗色背景，保留 PinkFairy 主题 */
.markdown-body .katex,
...
.markdown-body .katex-display {
  background: rgba(255, 238, 248, 0.15);
  padding: 1rem;
  border-radius: 8px;
...
.wiki-sidebar-header::before {
  ...
  background: linear-gradient(to right,
    transparent 0%,
    rgba(255, 158, 200, 0.6) 20%,
    rgba(255, 119, 204, 0.6) 50%,
    rgba(255, 158, 200, 0.6) 80%,
    transparent 100%);
}
...
.wiki-search-wrapper input:focus {
  outline: none;
  border-color: rgba(255, 119, 204, 0.7);
  background: rgba(39, 43, 51, 0.9);
  box-shadow: 0 0 0 4px rgba(255, 158, 200, 0.2), 
              0 4px 16px rgba(255, 119, 204, 0.3);
...
.search-results-dropdown {
  ...
  box-shadow: 0 8px 32px rgba(0, 0, 0, 0.6),
              0 2px 8px rgba(255, 158, 200, 0.2);
  max-height: 400px;
  overflow: hidden;
  z-index: 100;
  display: flex;
...
.markdown-body blockquote {
  ...
  color: #FF77CC;
  background: linear-gradient(to right, 
    rgba(255, 238, 248, 0.15) 0%, 
    rgba(27, 31, 35, 0.4) 100%);
  ...
  backdrop-filter: blur(20px);
  position: relative;
  border-right: 2px solid rgba(255, 158, 200, 0.4);
  border-top: 2px solid rgba(255, 158, 200, 0.4);
  border-bottom: 2px solid rgba(255, 158, 200, 0.4);
}
...
.markdown-body .caution:hover {
  ...
  box-shadow: 0 8px 32px rgba(255, 158, 200, 0.3),
              inset 0 1px 0 rgba(255, 158, 200, 0.3);
}
...
.markdown-body .info {
  ...
  border-right-color: rgba(255, 158, 200, 0.4);
  border-top-color: rgba(255, 158, 200, 0.4);
  border-bottom-color: rgba(255, 158, 200, 0.4);
  background: linear-gradient(to right, 
    rgba(255, 158, 200, 0.15), 
    rgba(27, 31, 35, 0.6));
  color: #f1f3f6;
}
...
.markdown-body a:hover {
  color: #FF77CC;
  text-decoration-color: rgba(255, 119, 204, 0.8);
  text-decoration-thickness: 2px;
  transform: translateY(-1px);
  text-shadow: 0 2px 4px rgba(255, 119, 204, 0.4);
}
...
.markdown-body a.internal-link {
  color: #FF77CC;
  font-weight: 700;
  border-bottom: 2px dashed rgba(255, 158, 200, 0.6);
  text-decoration: none;
}
...
.markdown-body img {
  ...
  display: block;
  object-fit: contain;
  border: 2px solid rgba(255, 158, 200, 0.5);
  transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1);
  background: rgba(27, 31, 35, 0.8);
  padding: 4px;
}
