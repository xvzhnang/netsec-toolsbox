  ...
  >
    ...
    >
      <div class="modal-form">
        ...
        <!-- Python 类型工具的专门配置面板 -->
        <div v-else-if="toolForm.toolType === 'Python'" class="python-config-panel">
          <label class="field">
            <span class="field-label">脚本路径</span>
            <div class="field-with-button">
              <input 
            ...
            <span class="field-hint">输入 Python 脚本的路径</span>
          </label>
          <label class="field">
            ...
            <div class="field-with-button">
              <input
                ...
                placeholder="选择或输入环境（留空使用系统环境）"
              />
              <datalist id="python-env-options">
                <option value="python3">python3 (推荐)</option>
                <option value="python2">python2 (兼容旧脚本)</option>
              </datalist>
            </div>
            <span class="field-hint">选择预设环境（.config/env/python/下的目录），或手动输入自定义目录名。留空则使用系统环境变量中的 python</span>
          </label>
          <label class="field">
