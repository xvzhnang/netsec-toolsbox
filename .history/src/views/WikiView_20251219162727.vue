...
.search-icon {
  ...
  pointer-events: none;
  z-index: 1;
  filter: drop-shadow(0 1px 2px rgba(45, 90, 45, 0.3));
}
...
.wiki-search-wrapper input:focus {
  ...
  box-shadow: 0 0 0 4px rgba(144, 238, 144, 0.3), 
              0 4px 16px rgba(152, 251, 152, 0.4);
...
.search-results-dropdown {
  ...
  border: 2px solid #90EE90;
  border-radius: 12px;
  box-shadow: 0 8px 32px rgba(144, 238, 144, 0.4),
              0 2px 8px rgba(152, 251, 152, 0.3);
  max-height: 400px;
  overflow: hidden;
  z-index: 100;
  display: flex;
